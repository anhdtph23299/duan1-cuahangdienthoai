...
public class InHoaDon extends javax.swing.JFrame {
 ...
 public void addTable(String Name, Double Price){
        ...
        String Qty = JOptionPane.showInputDialog("Nhập số lượng sản phẩm");
 ...
 public void bill_print(){
        ...
        try {
            bill.setText("                        Cửa hàng bán điện thoại \n");
            bill.setText(bill.getText() + "\t589/ Ha noi, \n");
            bill.setText(bill.getText() + "\tColombo, fpt, \n");
            bill.setText(bill.getText() + "\t+02938292, \n");
...
//       int responsite = JOptionPane.showConfirmDialog(this,"Bạn muốn có một vé đăng xuất khỏi  ?","Confirm",    JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
//        if (responsite == JOptionPane.YES_OPTION) {
//         new Xemthongtinsanpham().show();
            addTable("Pizza_1",2.00 );
//        }else if(responsite ==JOptionPane.NO_OPTION){
//            System.out.println("khong xem thi thoi");
//        }else if (responsite ==JOptionPane.CLOSED_OPTION){
//            System.out.println("phi qua");
//        }

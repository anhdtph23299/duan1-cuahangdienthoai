 ...
 * @author baby
 */
public class TaoQrcode extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TaoQrcode.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
